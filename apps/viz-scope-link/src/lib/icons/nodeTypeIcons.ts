 ...
 * Single source of truth for all node type icons across GoJS and React UI
 */
 ...
 * Icons are defined as SVG paths that can be used in both GoJS and React
 */
export const NODE_TYPE_ICONS: Record<NodeType, NodeTypeIconDef> = {
  Organization: {
  ...
  PDU: {
    geometry: "F M3 2 L13 2 L13 14 L3 14 z M6 5 A1 1 0 1 1 6 7 A1 1 0 0 1 6 5 z M10 5 A1 1 0 1 1 10 7 A1 1 0 0 1 10 5 z M6 9 A1 1 0 1 1 6 11 A1 1 0 0 1 6 9 z M10 9 A1 1 0 1 1 10 11 A1 1 0 0 1 10 9 z",
  ...
  "Rack PDU": {
    geometry: "F M4 1 L12 1 L12 15 L4 15 z M6 3 A0.5 0.5 0 1 1 6 4 A0.5 0.5 0 0 1 6 3 z M10 3 A0.5 0.5 0 1 1 10 4 A0.5 0.5 0 0 1 10 3 z M6 6 A0.5 0.5 0 1 1 6 7 A0.5 0.5 0 0 1 6 6 z M10 6 A0.5 0.5 0 1 1 10 7 A0.5 0.5 0 0 1 10 6 z M6 9 A0.5 0.5 0 1 1 6 10 A0.5 0.5 0 0 1 6 9 z M10 9 A0.5 0.5 0 1 1 10 10 A0.5 0.5 0 0 1 10 9 z M6 12 A0.5 0.5 0 1 1 6 13 A0.5 0.5 0 0 1 6 12 z M10 12 A0.5 0.5 0 1 1 10 13 A0.5 0.5 0 0 1 10 12 z",
  ...
  Server: {
    geometry: "F M2 3 L14 3 L14 6 L2 6 z M2 7 L14 7 L14 10 L2 10 z M2 11 L14 11 L14 14 L2 14 z M4 4.5 A0.5 0.5 0 1 1 4 5.5 A0.5 0.5 0 0 1 4 4.5 z M4 8.5 A0.5 0.5 0 1 1 4 9.5 A0.5 0.5 0 0 1 4 8.5 z M4 12.5 A0.5 0.5 0 1 1 4 13.5 A0.5 0.5 0 0 1 4 12.5 z",
  ...
  Chiller: {
    geometry: "F M8 2 L11 5 L9 5 L9 8 L11 8 L8 11 L5 8 L7 8 L7 5 L5 5 z M3 12 L13 12 M4 13 L12 13 M5 14 L11 14",
    path: "M8 2l3 3H9v3h2l-3 3-3-3h2V5H5l3-3zM3 12h10m-9 1h8m-7 1h6",
    viewBox: "0 0 16 16",
    size: 20,
  },
  CRAC: {
    geometry: "F M8 8 A5 5 0 1 1 8 8 z M8 3 L8 6 M11.5 4.5 L9.5 6.5 M13 8 L10 8 M11.5 11.5 L9.5 9.5 M8 13 L8 10 M4.5 11.5 L6.5 9.5 M3 8 L6 8 M4.5 4.5 L6.5 6.5",
 ...
 */
export const FALLBACK_ICON: NodeTypeIconDef = {
  geometry: "F M8 2 L8 10 M8 12 A0.5 0.5 0 1 1 8 13 A0.5 0.5 0 0 1 8 12 z M3 3 L13 3 L13 13 L3 13 z",
 ...
 */
export function getNodeTypeIcon(type: NodeType): NodeTypeIconDef {
  return NODE_TYPE_ICONS[type] || FALLBACK_ICON;
}
